...
async def private_receive_handler(c: Client, m: Message):
    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            if user.status == "kicked":
                await c.send_message(
                    chat_id=m.chat.id,
                    text="You are banned!\n\n  **Cᴏɴᴛᴀᴄᴛ Support [Support](https://t.me/potter_help_bot) They Wɪʟʟ Hᴇʟᴘ Yᴏᴜ**",
            ...
            await c.send_message(
                chat_id=m.chat.id,
                text="**Sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ Wʀᴏɴɢ. Cᴏɴᴛᴀᴄᴛ ᴍʏ Support** [Support](https://t.me/potter_help_bot)",
    ...
    try:
        ...
        video_url = "https://potterstreaming-upsclover843.koyeb.app/AgADQQ32"

        mx_player_link = f'intent:{video_url}#Intent;package=com.mxtech.videoplayer.ad;S.title={(get_name(log_msg))}end'
        ...
        await m.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("STREAM 🖥", url=stream_link), #Stream Link
                                                InlineKeyboardButton('DOWNLOAD 📥', url=mx_player_link)]]) #Download Link
        )
